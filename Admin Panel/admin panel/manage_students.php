...
<div class="addCounselor">

    <div class="addCounselorTable">

        <table class="counselor_columns" border="1">
            ...
            <tbody>
                ...
                $query = "SELECT * FROM students WHERE consent = 'Yes' AND add_counselor = 0";
                ...
                ?>
                        <tr>
                            ...
                            <td> <a class="main" href="add_to_main.php?id=<?= $row['id']; ?>" onclick="return confirm('Confirm?');"> +Main</a> </td>
                            <td> <a class="assistent1" href="add_to_assistent1.php?id=<?= $row['id']; ?>" onclick="return confirm('Confirm?');">+Assistent1</a> </td>
                            <td> <a class="assistent2" href="add_to_assistent2.php?id=<?= $row['id']; ?>" onclick="return confirm('Confirm?');">+Assistent2</a> </td>
