...
if (isset($_GET['id'])) {
    ...
    if ($result) {
        ...
        header('Location: anxiety_mild.php?yes');
    } else {
        header('Location: anxiety_mild.php?no');
    }
}

?>

<section class="mildAnxietyDetails">

    <div class="mildAnxietyTable">
        ...
        <table class="details" border="1">
            ...
            <tbody>
                ...
                //$query = "SELECT * FROM students WHERE consent = 'Yes' AND marks BETWEEN 5 AND 9 AND is_deleted_anxiety = 0";
                ...
                if ($counselorId == 1) {
                    $query = "SELECT * FROM students WHERE consent = 'Yes' AND marks BETWEEN 5 AND 9
                ...
                ?>
                        <tr>
                            ...
                            <td><?= $row['user_say']; ?></td>
                            <td><?= $row['marks']; ?></td>
                            <td> <a href="anxiety_mild.php?id=<?= $row['id']; ?>" onclick="return confirm('Are you sure delete the record?');">Remove</a> </td>
