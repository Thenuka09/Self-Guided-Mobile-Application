...
<div class="myStudentsDetails">

    <div class="my_studets_table">

        <table class="my_columns" border="1">
            ...
            <tbody>
                ...
                $query = "SELECT * FROM students WHERE consent = 'Yes' AND add_counselor = 1 AND is_deleted_student_from_main_counselor = 0";
                ...
                ?>
                        <tr>
                            ...
                            <td> <a class="delete" href="remove_main.php?id=<?= $row['id']; ?>" onclick="return confirm('Are you sure remove the record?');">Remove</a> </td>
