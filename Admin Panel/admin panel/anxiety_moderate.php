...
if (isset($_GET['id'])) {
    ...
    if ($result) {
        ...
        header('Location: anxiety_moderate.php?order_completed');
    } else {
        header('Location: anxiety_moderate.php?order_not_completed');
    }
}

?>

<section class="moderateAnxietyDetails">

    <div class="moderateAnxietyTable">
        ...
        <table class="details" border="1">
            ...
            <tbody>
                ...
                //$query = "SELECT * FROM students WHERE consent = 'Yes' AND marks BETWEEN 10 AND 14 AND is_deleted_anxiety = 0";
                ...
                if ($counselorId == 1) {
                    $query = "SELECT * FROM students WHERE consent = 'Yes' AND marks BETWEEN 10 AND 14 
                ...
                ?>
                        <tr>
                            ...
                            <td><?= $row['user_say']; ?></td>
                            <td><?= $row['marks']; ?></td>
                            <td> <a href="anxiety_moderate.php?id=<?= $row['id']; ?>" onclick="return confirm('Are you sure delete the record?');">Remove</a> </td>
