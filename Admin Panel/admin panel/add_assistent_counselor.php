...
<?php 
    ...
    if(isset($_POST['addAdminSubmit'])){
        ...
        $query = "INSERT INTO assistentcounselor ( name, phone_number , email, password) VALUES (
        ...
        if($result){
            ...
            header('Location: manage_assistent_counselor.php?insert_query = true');
        }else{
...
<div class="adminDiv">
    ...
    <form action="add_assistent_counselor.php" method="post" class="adminForm" id="signinForm">
