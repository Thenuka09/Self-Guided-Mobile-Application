...
<?php
    ...
    if($result){
        ...
        header('Location: depression_mild.php?order_completed');
        
    }else{
        header('Location: depression_mild.php?order_not_completed');
    }
    }

?>

<section class="mildDepressionDetails">

    <div class="mildDepressionTable">
        ...
        <table class="details" border="1">
            ...
            <tbody>
                ...
                <?php 
                    ...
                    //$query = "SELECT * FROM students WHERE consent = 'Yes' AND dep_marks BETWEEN 5 AND 9 AND is_deleted_depression = 0";
                    ...
                    if ($counselorId == 1) {
                        $query = "SELECT * FROM students WHERE consent = 'Yes' AND dep_marks BETWEEN 5 AND 9 
                        ...
                        foreach($result as $row){
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $row['dep_marks']; ?></td>
                                    <td> <a href="depression_mild.php?id=<?=$row['id'];?>" onclick="return confirm('Are you sure delete the record?');">Remove</a> </td>
