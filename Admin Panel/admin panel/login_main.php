...
if (isset($_POST['loginSubmitBtn'])) {    
    ...
    if (empty($error)) {
        ...
        $query = "SELECT * FROM counselor WHERE email = '{$username}' LIMIT 1";
        ...
        if ($result) {
            ...
            if (mysqli_num_rows($result) == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    $_SESSION['counselorID'] = $user['id'];
                    $_SESSION['mainCounselorName'] = $user['name'];

                    // Redirect to the all_details.php file
...
<body>
    ...
    <section class="formLoginSection">
        ...
        <div class="login">
            ...
            <form action="login_main.php" method="post" class="formLogin" id="formLogin">
