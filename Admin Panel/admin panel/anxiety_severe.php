...
if (isset($_GET['id'])) {
    ...
    if ($result) {
        ...
        header('Location: anxiety_severe.php?order_completed');
    } else {
        header('Location: anxiety_severe.php?order_not_completed');
    }
}

?>

<section class="severeAnxietyDetails">

    <div class="severeAnxietyTable">
        ...
        <table class="details" border="1">
            ...
            <tbody>
                ...
                //$query = "SELECT * FROM students WHERE consent = 'Yes' AND marks BETWEEN 15 AND 21 AND is_deleted_anxiety = 0";
                ...
                if ($counselorId == 1) {
                    $query = "SELECT * FROM students WHERE consent = 'Yes' AND marks BETWEEN 15 AND 21 
                ...
                ?>
                        <tr>
                            ...
                            <td><?= $row['user_say']; ?></td>
                            <td><?= $row['marks']; ?></td>
                            <td> <a href="anxiety_severe.php?id=<?= $row['id']; ?>" onclick="return confirm('Are you sure remove the record?');">Remove</a> </td>
