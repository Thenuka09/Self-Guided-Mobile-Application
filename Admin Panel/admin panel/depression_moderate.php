...
if (isset($_GET['id'])) {
    ...
    if ($result) {
        ...
        header('Location: depression_moderate.php?order_completed');
    } else {
        header('Location: depression_moderate.php?order_not_completed');
    }
}

?>

<section class="moderateDepressionDetails">

    <div class="moderateDepressionTable">
        ...
        <table class="details" border="1">
            ...
            <tbody>
                ...
                //$query = "SELECT * FROM students WHERE consent = 'Yes' AND dep_marks BETWEEN 10 AND 14 AND is_deleted_depression = 0";
                ...
                if ($counselorId == 1) {
                    $query = "SELECT * FROM students WHERE consent = 'Yes' AND dep_marks BETWEEN 10 AND 14 
                ...
                ?>
                        <tr>
                            ...
                            <td><?= $row['dep_marks']; ?></td>
                            <td> <a href="depression_moderate.php?id=<?= $row['id']; ?>" onclick="return confirm('Are you sure delete the record?');">Remove</a> </td>
