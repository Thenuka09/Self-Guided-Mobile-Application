...
if (isset($_POST['editAdminSubmit'])) {
    ...
    if ($result) {
        header('Location: manage_assistent_counselor.php?status=success');
        exit();
    } else {
        header('Location: manage_assistent_counselor.php?status=error');
...
<section class="addAdminSection">
    <div class="adminDiv">
        ...
        ?>
                <form action="edit_assistent.php" method="post" class="adminForm" id="signinForm">
