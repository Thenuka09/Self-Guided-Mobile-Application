...
public class DepressionQuestiontwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depression_questiontwo);
...
//        });
    ...
    public void storeMarks(){
        ...
        editor.putInt("Depression_Question_Two", depressionMark);
        editor.apply();

        //test the marks
        Log.d("Depression_Two", String.valueOf(depressionMark));

        //goto second question
        Intent intent = new Intent(DepressionQuestiontwoActivity.this, DepressionQuestionthreeActivity.class);
