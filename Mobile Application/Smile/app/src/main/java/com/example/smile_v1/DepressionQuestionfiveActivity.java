...
public class DepressionQuestionfiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depression_questionfive);
...
//        });
    ...
    public void storeMarks(){
        ...
        editor.putInt("Depression_Question_Five", depressionMark);
        editor.apply();

        //test the marks
        Log.d("Depression_Five", String.valueOf(depressionMark));

        //goto second question
        Intent intent = new Intent(DepressionQuestionfiveActivity.this, DepressionQuestionsixActivity.class);
