...
//        });
    ...
    public void buttonNext(){
        ...
        // save and apply the changes to the shared preferences
        editor.putInt("Question_Two", marks);
        editor.apply();

        // create new integer variable to store the addition of marks
        int newMarks;
        newMarks = previousMarks + marks;

        // test the values
        Log.d("Marks1",String.valueOf(marks));
        Log.d("New_Marks1", String.valueOf(newMarks));
