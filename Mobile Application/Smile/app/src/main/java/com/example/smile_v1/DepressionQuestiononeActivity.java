...
public class DepressionQuestiononeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depression_questionone);
...
//        });
    ...
    public void storeMarks(){
        ...
        editor.putInt("Depression_Question_One", depressionMark);
        editor.apply();

        //test the marks
        Log.d("Depression_One", String.valueOf(depressionMark));

        //goto second question
        Intent intent = new Intent(DepressionQuestiononeActivity.this, DepressionQuestiontwoActivity.class);
