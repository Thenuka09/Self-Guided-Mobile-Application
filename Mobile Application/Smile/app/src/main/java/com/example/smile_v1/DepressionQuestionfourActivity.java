...
public class DepressionQuestionfourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depression_questionfour);
...
//        });
    ...
    public void storeMarks(){
        ...
        editor.putInt("Depression_Question_Four", depressionMark);
        editor.apply();

        //test the marks
        Log.d("Depression_Four", String.valueOf(depressionMark));

        //goto second question
        Intent intent = new Intent(DepressionQuestionfourActivity.this, DepressionQuestionfiveActivity.class);
