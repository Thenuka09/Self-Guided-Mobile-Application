...
//        });
    ...
    private void buttonNext() {
        ...
        editor.putInt("Question_Four", marks);
        editor.apply();

        // create new variable to store new marks
        int newMarks;
        newMarks = previousMarks + marks;

        // test the marks
        Log.d("Marks3", String.valueOf(marks));
        Log.d("New_Marks3", String.valueOf(newMarks));

        // pass the new marks to the activity three
        Intent intent = new Intent(getApplicationContext(), QuestionFiveActivity.class);
