...
public class DepressionQuestionsixActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depression_questionsix);
...
//        });
    ...
    public void storeMarks(){
        ...
        editor.putInt("Depression_Question_Six", depressionMark);
        editor.apply();

        //test the marks
        Log.d("Depression_Six", String.valueOf(depressionMark));

        //goto second question
        Intent intent = new Intent(DepressionQuestionsixActivity.this, DepressionQuestionsevenActivity.class);
