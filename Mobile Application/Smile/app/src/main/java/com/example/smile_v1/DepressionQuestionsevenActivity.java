...
public class DepressionQuestionsevenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depression_questionseven);
...
//        });
    ...
    public void storeMarks(){
        ...
        editor.putInt("Depression_Question_Seven", depressionMark);
        editor.apply();

        //test the marks
        Log.d("Depression_Seven", String.valueOf(depressionMark));

        //goto second question
        Intent intent = new Intent(DepressionQuestionsevenActivity.this, DepressionQuestioneightActivity.class);
